...
model
# The Shoemaker and the Nanobots
model
Narrator: The year is 2242. The city is a labyrinth of steel and concrete. The air is thick with exhaust fumes and the stench of decay.
model
Narrator: In the shadow of a towering factory, lives a reclusive old craftsman. He is known only as the Shoemaker.
model
Narrator: He lives in a ramshackle workshop, where he repairs and builds custom bio-mechanical limbs for the city’s outcasts.
model
Narrator: He is a man of few words and even fewer friends.
