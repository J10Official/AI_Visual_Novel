...
**Parameters:** {'temperature': 0.9, 'top_k': 10}  
...
The old workshop is dim, lit only by the red glow of a single lamp. The old man sits hunched, eyes closed, breathing heavily. His hands are calloused and gnarled.
A small, dark object, like a beetle, flies from his workbench. He is startled.
